...
const langSk = {
  ...
  "#lp-small-contact-text":
    "<h4>Sledujte Blackwater Digital</h4><p>Sledujte nás na všetkých sociálnych sieťach. V pravidelných intervaloch pridávame obsah, ktorý je pre našich klientov relevantný.</p>",
  ...
  "#about-hero-text":
    "<p>V Blackwater Digital zaisťujeme aby sa Váš nápad stal realitou.</p>",

  ".mission-statement-container":
    '<div class="author-container"><h3>Programové prehlásenie</h3></div><h1>Naša misia je posunúť Váš biznis na vyšší level — digitálny level.</h1>',
