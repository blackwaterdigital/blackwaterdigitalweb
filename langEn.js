...
const langEn = {
  ...
  "#lp-small-contact-text":
    "<h4>Follow Blackwater Digital</h4><p>Keep up with us and our activities on our social media accounts. We post on a regular basis.</p>",
  ...
  "#about-hero-title":
    '<h1>We are here just for<span class="bold"> you</span>.</h1>',

  "#about-hero-text":
    "<p>Blackwater Digital makes sure your idea gets transformed into reality.</p>",

  ".mission-statement-container":
    '<div class="author-container"><h3>Mission Statement</h3></div><h1>Our mission is to take your business to the next level — the digital level.</h1>',
  ...
  ".all-projects-showcase > .work-showcase-container > #caselink-client > .text-container > p":
